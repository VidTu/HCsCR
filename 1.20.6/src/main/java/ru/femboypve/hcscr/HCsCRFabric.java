...
public final class HCsCRFabric implements ClientModInitializer {
    public static final CustomPacketPayload.Type<DisablingPayload> LOCATION = new CustomPacketPayload.Type<>(new ResourceLocation("hcscr", "haram"));
    ...
    public static boolean removeClientSide(Entity entity, DamageSource source, float amount, Set<Entity> checked) {
        ...
        if (entity instanceof EndCrystal) {
            ...
            if (!HCsCR.removeInteractions) return false;
        } else {
            return false;
        }
