...
|---------------------------|---------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
| Бета&nbsp;&#x1F195;       | (нет)                                                                                                   | Версии со свежей поддержкой. Могут быть нестабильны, но тут ведётся *активная* разработка функционала и *активное* исправление багов.           |
| Активная&nbsp;&#x2705;    | 26.2, 26.1.2, 1.21.11, 1.21.1, 1.20.1                                                                   | Активно поддерживаемые версии. Хорошо протестированы, функционал *часто* портируется с новых версий, ведётся *активное* исправление багов.      |
