...
| Функциональная&nbsp;&#x26A0; | 1.21.10, 1.21.8, 1.21.5, 1.21.4, 1.21.3, 1.20.6, 1.20.4, 1.20.2, 1.19.4, 1.19.2, 1.18.2, 1.17.1, 1.16.5 | Версии, поддерживаемые по возможности. Функционал *иногда* портируется. Баги *часто* исправляются. Критические баги будут *активно* исправлены. |
...
**А**: Смотрите [Поддерживаемые версии](#поддерживаемые-версии).
