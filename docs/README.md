...
|----------------------|-----------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------|
| Beta&nbsp;&#x1F195;  | 26.4                                                                                                            | Newly supported versions. May be unstable, but *active* feature development happens here, bugs are *actively* fixed.                        |
| Active&nbsp;&#x2705; | 26.3, 26.2, 26.1.2, 1.21.11, 1.21.1                                                                             | Actively supported versions. Well tested, features are *often* backported and bugs are *actively* fixed.                                    |
...
- Various CLI tools (`cat, cut, curl, grep, jq, mktemp, sed, sh, tr`) used by
  the [upload](https://github.com/VidTu/HCsCR/blob/main/dev/upload) script.
