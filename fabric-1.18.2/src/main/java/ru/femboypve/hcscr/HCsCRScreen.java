...
public final class HCsCRScreen extends Screen {
    ...
    protected void init() {
        addRenderableWidget(enabled = new Checkbox(
                width / 2 - 12 - font.width(new TranslatableComponent("hcscr.screen.enabled")) / 2, 40,
                24 + font.width(new TranslatableComponent("hcscr.screen.enabled")), 20,
                new TranslatableComponent("hcscr.screen.enabled"), HCsCR.enabled));
        addRenderableWidget(removeCrystals = new Checkbox(
                width / 2 - 12 - font.width(new TranslatableComponent("hcscr.screen.removeCrystals")) / 2, 64,
                24 + font.width(new TranslatableComponent("hcscr.screen.removeCrystals")), 20,
                new TranslatableComponent("hcscr.screen.removeCrystals"), HCsCR.removeCrystals));
        addRenderableWidget(removeSlimes = new Checkbox(
                width / 2 - 12 - font.width(new TranslatableComponent("hcscr.screen.removeSlimes")) / 2, 88,
                24 + font.width(new TranslatableComponent("hcscr.screen.removeSlimes")), 20,
                new TranslatableComponent("hcscr.screen.removeSlimes"), HCsCR.removeSlimes));
        addRenderableWidget(removeInteractions = new TCheckbox(
                width / 2 - 12 - font.width(new TranslatableComponent("hcscr.screen.removeInteractions")) / 2, 112,
                24 + font.width(new TranslatableComponent("hcscr.screen.removeInteractions")), 20,
                new TranslatableComponent("hcscr.screen.removeInteractions"), HCsCR.removeInteractions, this,
                new TranslatableComponent("hcscr.screen.removeInteractions.version")));
        addRenderableWidget(removeAnchors = new Checkbox(
                width / 2 - 12 - font.width(new TranslatableComponent("hcscr.screen.removeAnchors")) / 2, 136,
                24 + font.width(new TranslatableComponent("hcscr.screen.removeAnchors")), 20,
                new TranslatableComponent("hcscr.screen.removeAnchors"), HCsCR.removeAnchors));
        addRenderableWidget(new Slider(width / 2 - 100, 160, 200, 20,
                HCsCR.delay, 0, 200, value -> HCsCR.delay = value,
                value -> CommonComponents.optionNameValue(new TranslatableComponent("hcscr.screen.delay"),
    ...
    public void render(PoseStack stack, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredString(stack, font, new TranslatableComponent("hcscr.screen.serverDisabled"), width / 2, height - 34, 0xFFFF0000);
    }
    ...
    private static final class TCheckbox extends Checkbox {
        private final Screen parent;
        private final Component tooltip;

        public TCheckbox(int x, int y, int width, int height, Component text, boolean checked,
                         Screen parent, Component tooltip) {
        ...
        public void renderToolTip(PoseStack stack, int mouseX, int mouseY) {
            ...
            if (tooltip != null) {
                parent.renderTooltip(stack, tooltip, mouseX, mouseY);
            }
        }
    }
}
