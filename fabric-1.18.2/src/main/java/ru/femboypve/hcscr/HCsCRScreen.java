...
public class HCsCRScreen extends Screen {
    ...
    @Override
    protected void init() {
        addRenderableWidget(enabled = new Checkbox(width / 2 - font.width(new TranslatableComponent("hcscr.screen.enabled")), 40, 24 + font.width(new TranslatableComponent("hcscr.screen.enabled")), 20, new TranslatableComponent("hcscr.screen.enabled"), HCsCRFabric.enabled));
