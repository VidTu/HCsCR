...
final class ServerStatePacket implements FabricPacket {
    ...
    static void init() {
        ...
        ClientConfigurationNetworking.registerGlobalReceiver(PACKET_TYPE, (packet, responseSender) -> handlePacket(packet));
        ...
        ClientConfigurationConnectionEvents.INIT.register((handler, client) -> resetState(client));
