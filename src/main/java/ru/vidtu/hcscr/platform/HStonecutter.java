...
public final class HStonecutter {
    ...
    *///?} else
    ...
    public static Button guiButton(Font font, int x, int y, int width, int height, Component message,
        ...
        assert (x >= -Window.BASE_WIDTH) && (x <= Math.max(Minecraft.getInstance().getWindow().getGuiScaledWidth(), Window.BASE_WIDTH)) : "HCsCR: Parameter 'x' is not in the [" + -Window.BASE_WIDTH + ".." + Math.max(Minecraft.getInstance().getWindow().getGuiScaledWidth(), Window.BASE_WIDTH) + "] range. (font: " + font + ", x: " + x + ", y: " + y + ", width: " + width + ", height: " + height + ", message: " + message + ", tooltip: " + tooltip + ", handler: " + handler + ", tooltipRenderer: " + tooltipRenderer + ')';
        assert (y >= -Window.BASE_HEIGHT) && (y <= Math.max(Minecraft.getInstance().getWindow().getGuiScaledHeight(), Window.BASE_HEIGHT)) : "HCsCR: Parameter 'y' is not in the [" + -Window.BASE_HEIGHT + ".." + Math.max(Minecraft.getInstance().getWindow().getGuiScaledHeight(), Window.BASE_HEIGHT) + "] range. (font: " + font + ", x: " + x + ", y: " + y + ", width: " + width + ", height: " + height + ", message: " + message + ", tooltip: " + tooltip + ", handler: " + handler + ", tooltipRenderer: " + tooltipRenderer + ')';
    ...
    public static Checkbox guiCheckbox(Font font, int x, int y, Component message, Component tooltip, boolean check,
        ...
        assert (x >= -Window.BASE_WIDTH) && (x <= Math.max(Minecraft.getInstance().getWindow().getGuiScaledWidth(), Window.BASE_WIDTH)) : "HCsCR: Parameter 'x' is not in the [" + -Window.BASE_WIDTH + ".." + Math.max(Minecraft.getInstance().getWindow().getGuiScaledWidth(), Window.BASE_WIDTH) + "] range. (font: " + font + ", x: " + x + ", y: " + y + ", message: " + message + ", tooltip: " + tooltip + ", check: " + check + ", handler: " + handler + ", tooltipRenderer: " + tooltipRenderer + ')';
        assert (y >= -Window.BASE_HEIGHT) && (y <= Math.max(Minecraft.getInstance().getWindow().getGuiScaledHeight(), Window.BASE_HEIGHT)) : "HCsCR: Parameter 'y' is not in the [" + -Window.BASE_HEIGHT + ".." + Math.max(Minecraft.getInstance().getWindow().getGuiScaledHeight(), Window.BASE_HEIGHT) + "] range. (font: " + font + ", x: " + x + ", y: " + y + ", message: " + message + ", tooltip: " + tooltip + ", check: " + check + ", handler: " + handler + ", tooltipRenderer: " + tooltipRenderer + ')';
    ...
    public static AbstractSliderButton guiSlider(Font font, int x, int y, int width, int height,
        ...
        assert (x >= -Window.BASE_WIDTH) && (x <= Math.max(Minecraft.getInstance().getWindow().getGuiScaledWidth(), Window.BASE_WIDTH)) : "HCsCR: Parameter 'x' is not in the [" + -Window.BASE_WIDTH + ".." + Math.max(Minecraft.getInstance().getWindow().getGuiScaledWidth(), Window.BASE_WIDTH) + "] range. (font: " + font + ", x: " + x + ", y: " + y + ", width: " + width + ", height: " + height + ", message: " + message + ", tooltip: " + tooltip + ", value: " + value + ", min: " + min + ", max: " + max + ", handler: " + handler + ", tooltipRenderer: " + tooltipRenderer + ')';
        assert (y >= -Window.BASE_HEIGHT) && (y <= Math.max(Minecraft.getInstance().getWindow().getGuiScaledHeight(), Window.BASE_HEIGHT)) : "HCsCR: Parameter 'y' is not in the [" + -Window.BASE_HEIGHT + ".." + Math.max(Minecraft.getInstance().getWindow().getGuiScaledHeight(), Window.BASE_HEIGHT) + "] range. (font: " + font + ", x: " + x + ", y: " + y + ", width: " + width + ", height: " + height + ", message: " + message + ", tooltip: " + tooltip + ", value: " + value + ", min: " + min + ", max: " + max + ", handler: " + handler + ", tooltipRenderer: " + tooltipRenderer + ')';
