...
public final class HPlugin implements IMixinConfigPlugin {
     ...
     */
    @CompileTimeConstant
    private static final int ERROR_EXIT_CODE = 68602183; // "HCsCR".hashCode()
    ...
    private boolean shouldUseMixinExtras() {
        ...
        if (!"auto".equalsIgnoreCase(property)) {
            // Log, exit, throw.
            LOGGER.error(HCSCR_MARKER, "HCsCR: System property 'ru.vidtu.hcscr.mixinextras' set to an invalid value '{}'. Allowed values are: 'true', 'false', and 'auto'.", property);
