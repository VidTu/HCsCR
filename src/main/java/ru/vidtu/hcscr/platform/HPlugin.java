...
public final class HPlugin implements IMixinConfigPlugin {
    /^*
     * Marker for all logs generated by the mod. It is reduplicated
     * here, because {@link HCsCR#MARKER} can't be loaded early.
     *
     * @see HCsCR#MARKER
     ^/
    @UnknownNullability
    ...
    public boolean shouldApplyMixin(final String targetClassName, final String mixinClassName) {
        ...
        if (Variables.DEBUG_LOGS && LOGGER.isDebugEnabled(MARKER)) {
            if (applyMixin) {
                ...
                LOGGER.debug(MARKER, "HCsCR: Mixin has been ruled out due to MixinExtras rules, mixin WON'T be applied. (targetClassName: {}, mixinClassName: {}, plugin: {})", targetClassName, mixinClassName, this);
            }
        }
    ...
    /^*
     * Checks if the MixinExtras mixins can be used in place of plain mixins for better compatibility.
     *
