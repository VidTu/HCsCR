...
public final class HCsCR {
     ...
     */
    @UnknownNullability
    public static final Marker MARKER = (HVariables.DEBUG_LOGS ? MarkerManager.getMarker("MOD_HCSCR") : null);
     ...
     */
    @UnknownNullability
    private static final Logger LOGGER = (HVariables.DEBUG_LOGS ? LogManager.getLogger("HCsCR/HCsCR") : null);
